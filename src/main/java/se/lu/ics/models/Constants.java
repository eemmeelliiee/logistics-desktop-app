...
// alla måste vara public static final
    // public static final String NO_SHIPMENT_EXISTS_WITH_THAT_ID = "No shipment with ID exists";
    ...
    public static final String NO_WAREHOUSE_EXISTS_WITH_THAT_NAME = "Error: No warehouse with given name exists";
    public static final String ALREADY_EXISTS_WAREHOUSE_WITH_NAME = "Error: A warehouse with given name already exists";
    public static final String CANNOT_BE_EMPTY = "Erro: Field cannot be empty";
